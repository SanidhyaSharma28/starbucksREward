  ...
  return (
    <div className='sticky-header'>
        ...
        <div className='switcher' style={{display:"flex",justifyContent:"space-between",alignItems:"center"}}>
            <img id="logo" style={{margin:"10px"}} src="\utilities\starbucks-logo-png.png" alt="starbuck's logo" />
        ...
        <div style={{display:"flex",alignItems:"center"}} >
            <img href="#" id='Findlocation' style={{marginRight:"0px"}} src="\utilities\asdadaczc.png" alt="FIND A STORE" />
